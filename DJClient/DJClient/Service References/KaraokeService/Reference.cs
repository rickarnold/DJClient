...
namespace DJ.KaraokeService {
    ...
    public interface IDJ {
        ...
        DJ.KaraokeService.Response DJSignUp(string userName, string password, DJ.KaraokeService.Venue venue, string email);
        ...
        DJ.KaraokeService.Response DJNewUserWaitTime(long DJKey);
    }
    ...
    public partial class DJClient : System.ServiceModel.ClientBase<DJ.KaraokeService.IDJ>, DJ.KaraokeService.IDJ {
        ...
        public DJ.KaraokeService.Response DJSignUp(string userName, string password, DJ.KaraokeService.Venue venue, string email) {
        ...
        public DJ.KaraokeService.Response DJGetQRNumber(long DJKey) {
        ...
        public DJ.KaraokeService.Response DJNewUserWaitTime(long DJKey) {
